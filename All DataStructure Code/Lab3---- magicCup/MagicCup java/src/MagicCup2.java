...
class MagicCup2<T> implements magic<T>, Comparable<T>{
    ...
    public ArrayList<T> addToCup(){
        ...
        System.out.println("Please enter anything that you like to add to magic cup 2. Specify the number of elements followed by the list itself ");
