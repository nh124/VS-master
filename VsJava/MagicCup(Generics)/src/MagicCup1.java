...
interface magic<T> {
    boolean empty();
    ArrayList<T> addToCup();
    ArrayList<T> removeFromCup();
    ArrayList<T> cupDisplay();
    boolean searchCup();
}
class MagicCup1<T> implements magic<T>, Comparable<T>{
    ...
    public ArrayList<T> addToCup(){
        ...
        System.out.println("Please enter anything that you like to add to magic cup 1. Specify the number of elements followed by the list itself ");
